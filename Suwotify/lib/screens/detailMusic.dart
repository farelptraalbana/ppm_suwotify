...
class MusicData {
  ...
  MusicData(
      this.imageUrl, this.audioUrl, this.title, this.artist, this.keyYoutube);
}
...
class _DetailMusicState extends State<DetailMusic> {
  ...
  void initState() {
    ...
    _dataFuture = getDataMusic(musicId).then((musicData) {
      keyYoutube = musicData.keyYoutube;
      print("KEYYOUTUBE : " + keyYoutube);
      _youtubeController = YoutubePlayerController(
        initialVideoId: keyYoutube as String,
  ...
  Future<MusicData> getDataMusic(int id) async {
    try {
      ...
      if (imageResponse != null &&
        ...
        String keyYoutube = savedAudioData['data']['attributes']['keyYoutube'];

        return MusicData(imageUrl, audioUrl, title, artistName, keyYoutube);
      } else {
